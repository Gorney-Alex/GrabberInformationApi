...
public class HHruParser
{
    ...
    public async Task<List<CompetencyResult>> ParseVacanciesAsync(string[] searchQueries, int pagesToFetch)
    {
        var skillFrequency = new Dictionary<string, int>();
                ...
                if (items != null)
                {
                    foreach (var item in items)
                    {
                        ...
                        if (idToken != null)
                        {
                            ...
                            totalVacancies++;
                            await ParseVacancyAsync(vacancyId, skillFrequency);
                        }
                    }
                }
            }
    ...
    private async Task ParseVacancyAsync(string vacancyId, Dictionary<string, int> skillFrequency)
    {
        try
        {
